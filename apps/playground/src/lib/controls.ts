 ...
 * stand in chrome around specimens from both adapters, and either adapter's own
 * component would be the wrong one on half of every page. That is a reason to hand-write the elements, not a
