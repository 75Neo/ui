...
export const Default = meta.story({
  render: () => ({
    ...
    template: `<div class="w-full max-w-xl"><Accordion :items="items" :default-value='["item-1"]' collapsible /></div>`,
  }),
});
...
export const Multiple = meta.story({
  render: () => ({
    ...
    template: `<div class="w-full max-w-xl"><Accordion :items="items" :default-value='["item-1", "item-2"]' type="multiple" /></div>`,
  }),
});
...
export const Disabled = meta.story({
  render: () => ({
    ...
    template: `<div class="w-full max-w-xl"><Accordion :items="items" :default-value='["item-1"]' collapsible disabled /></div>`,
  }),
});
