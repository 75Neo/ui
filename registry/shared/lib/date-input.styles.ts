...
export const dateInput = tv({
  slots: {
    ...
    control:
      "flex h-9 w-full min-w-0 items-center gap-2 rounded-md bg-default px-3 ring ring-default focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-inverted data-disabled:opacity-75 data-invalid:ring-error",
