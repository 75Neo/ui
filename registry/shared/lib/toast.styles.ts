...
export const toast = tv({
  slots: {
    ...
    actionTrigger:
      "mt-1 self-start rounded-md text-sm font-medium text-primary transition-colors hover:text-primary-hover focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus",
    closeTrigger:
