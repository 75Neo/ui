...
export const steps = tv({
  slots: {
    ...
    trigger:
      "flex cursor-pointer items-center gap-2.5 text-sm font-medium text-muted transition-colors hover:text-default focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus disabled:pointer-events-none disabled:opacity-75 data-complete:text-default data-current:text-default",
    indicator:
      "flex size-7 shrink-0 items-center justify-center rounded-full text-xs font-medium ring ring-default transition-colors data-complete:bg-primary-soft data-complete:text-primary data-complete:ring-primary-border data-current:bg-primary data-current:text-primary-fg data-current:ring-primary [&>svg]:size-3.5",
    separator:
    ...
    nextTrigger:
      "inline-flex h-9 cursor-pointer items-center rounded-md bg-primary px-3 text-sm font-medium text-primary-fg transition-colors hover:bg-primary-hover focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus disabled:pointer-events-none disabled:opacity-50",
    prevTrigger:
