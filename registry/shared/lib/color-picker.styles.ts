...
export const colorPicker = tv({
  slots: {
    ...
    trigger:
      "inline-flex size-9 shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-md p-1 ring ring-default transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-inverted data-disabled:pointer-events-none data-disabled:opacity-75",
    ...
    channelInput:
      "h-8 w-full min-w-0 rounded-md bg-default px-2 font-mono text-xs text-default ring ring-default outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-inverted",
    transparencyGrid: "rounded-md",
    swatchGroup: "flex flex-wrap gap-1.5",
    swatchTrigger:
      "size-6 cursor-pointer overflow-hidden rounded-sm ring ring-default transition-transform focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-inverted data-[state=checked]:ring-2 data-[state=checked]:ring-primary",
    swatch: "size-full",
    swatchIndicator: "flex size-full items-center justify-center text-white [&>svg]:size-3",
    eyeDropperTrigger:
      "inline-flex size-8 shrink-0 cursor-pointer items-center justify-center rounded-md text-muted transition-colors hover:bg-muted hover:text-default focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-inverted [&>svg]:size-4",
    formatTrigger:
