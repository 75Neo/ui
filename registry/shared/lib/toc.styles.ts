...
export const toc = tv({
  slots: {
    ...
    link: "block w-full rounded-md py-1 ps-3 pe-2 text-muted no-underline transition-colors hover:text-default focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus data-active:font-medium data-active:text-primary",
    indicator:
