...
export const splitter = tv({
  slots: {
    ...
    resizeTrigger:
      "group/resize flex shrink-0 items-center justify-center transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus data-[orientation=horizontal]:w-2 data-[orientation=horizontal]:cursor-col-resize data-[orientation=vertical]:h-2 data-[orientation=vertical]:cursor-row-resize",
