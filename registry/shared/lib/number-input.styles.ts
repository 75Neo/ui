...
export const numberInput = tv({
  slots: {
    ...
    control:
      "flex items-stretch overflow-hidden rounded-md bg-default ring ring-default focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-inverted data-disabled:opacity-75 data-invalid:ring-error",
    input:
