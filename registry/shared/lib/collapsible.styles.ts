...
export const collapsible = tv({
  slots: {
    ...
    trigger:
      "flex w-full cursor-pointer items-center justify-between gap-4 text-start text-sm font-medium text-default transition-colors hover:text-primary focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus data-disabled:pointer-events-none data-disabled:opacity-75",
    indicator:
