...
export const tour = tv({
  slots: {
    ...
    spotlight: "fixed z-50 rounded-md outline-2 outline-inverted",
    positioner: "z-50",
    content:
    ...
    actionTrigger:
      "inline-flex h-8 cursor-pointer items-center rounded-md px-2.5 text-xs font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-inverted",
    closeTrigger:
