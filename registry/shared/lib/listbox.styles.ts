...
export const listbox = tv({
  slots: {
    ...
    input:
      "h-9 w-full min-w-0 rounded-md bg-default px-3 text-sm text-default ring ring-default transition-colors outline-none placeholder:text-dimmed focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-inverted",
    content:
